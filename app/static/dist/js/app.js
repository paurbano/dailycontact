$(document).ready(function () {
    ...
    $('#add_person').click(function (e) {
      e.preventDefault();
      $('#persons').append('<div class="row col-sm-10"><input type="text" class="form-control mt-2" name="person[]" placeholder="Ingrese el nombre" required><a href="#" class="btn btn-danger remover_person">-</div>');
    });
